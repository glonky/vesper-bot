...
export interface ExtendedErrorProps {
...
export type RethrownExtendedErrorProps = ExtendedErrorProps & Required<Pick<ExtendedErrorProps, 'error'>>;
...
export class ExtendedError extends Error {
  ...
  constructor(message: string, props?: ExtendedErrorProps | RethrownExtendedErrorProps) {
    super(message);
